...
def get_dv(start = 20170101,end = 20180101):
    ...
    #define
    factor_list  = ['volume','total_liab','tot_assets','net_profit','capital_stk','capital_reser','net_cash_flows_inv_act']
...
from Tamplate import alpha168,DebtsAsset_Ratio,alpha34,MA_5,alpha165,CapitalSurplusFundPS, InvestCash_GrowRate

for f in ['alpha168','DebtsAsset_Ratio', 'alpha34','MA_5','alpha165','CapitalSurplusFundPS','InvestCash_GrowRate']:
